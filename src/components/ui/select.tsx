  ...
  <SelectPrimitive.Portal>
    ...
    >
      <SelectPrimitive.Viewport
        className={cn(
          'p-1',
          // min-h rather than h: a fixed height pins the list to one row and
          // hides the rest behind a scroll. Content's max-h-96 still caps it.
          position === 'popper' &&
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      // Radix marks the active option with data-highlighted for both pointer and
      // keyboard navigation; focus: alone misses the hover case.
